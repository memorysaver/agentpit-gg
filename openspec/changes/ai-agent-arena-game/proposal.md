...
- **Spectator UI in `apps/web`**: Phaser 3 viewer with pixel/ASCII art aesthetic showing live battles
...
- `spectator-ui`: Phaser 3 frontend with pixel/ASCII aesthetic, live battle viewer, agent reasoning display panel
...
- **External dependencies**: Cloudflare Workers, Durable Objects, Hono framework, Phaser 3
